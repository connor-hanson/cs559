function setup() {
	...
	function drawObject(Tx, x, y, z, xT, yT, zT) {
	...
	function drawObjectOneCol(Tx, x, y, z, xT, yT, zT, Color) {
	...
	function drawBodyNArms(Tx) {
		...
		if(vec3.dot(normal, locCamera) >= 0) {
			drawObjectOneCol(Tx, 0.2, 0.2, 0.2, 0.7, 1, 0, 'rgb(211,211,211)');

			drawObjectOneCol(Tx, 0.5, 0.5, 0.5, 0, 1, 0, 'rgb(211,211,211)');
	...
	function drawFace(Tx) {
		...
		drawObjectOneCol(Tx, 0.3, 0.2, 0.05, 0, 0.8, 0.55, 'green');

		if(vec3.dot(normal, locCamera) >= 0) {
			drawObjectOneCol(Tx, 0.1, 0.1, 0.05, 0.3, 1.25, 0.55, 'green');
	...
	//USE THIS TO USE YOUR OBJECT/KIRBY!!!!!!! TODO
	...
	drawBodyNArms(tVP_CAM_MOD);
	
	drawFace(tVP_CAM_MOD);
